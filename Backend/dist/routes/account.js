...
router.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userSubmitted, inUser, inPassword, account, valid, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, argon2.verify(account.password, inPassword)];
            case 3:
                valid = _a.sent();
                if (!valid) {
                    res.status(500).json({ error: "Failed to fetch users" });
...
router.post("/register", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userSubmitted, inUser, inPassword, account, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
