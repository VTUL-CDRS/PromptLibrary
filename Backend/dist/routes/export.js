 ...
 * Export all prompts
 */
router.get("/all/admin", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var prompts, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
 ...
 * Export all prompts
 */
router.get("/all/notadmin", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var prompts, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
